      ...
      <div class="flex-1 space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div class="p-6">
            ...
            />
            <label class="block text-sm font-medium text-gray-700 mb-2 mt-4">Delivery Challan Number (Optional)</label>
            <input 
              type="text" 
              v-model="deliveryChallanNumber" 
...
const deliveryChallanNumber = ref('')
...
const submitInvoice = async () => {
  ...
  try {
    const payload = {
      ...
      delivery_challan_number: deliveryChallanNumber.value || '',
