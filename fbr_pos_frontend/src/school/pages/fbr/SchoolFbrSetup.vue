        ...
        <div class="flex items-center justify-between mb-4">
          <div>
            ...
            <p class="text-sm text-gray-600">
              Enter your FBR production bearer token after all sandbox scenarios have passed.
            </p>
            <span v-if="hasProductionToken" class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-green-100 text-green-800 border border-green-200 mt-2">
              ENVIRONMENT: PRODUCTION
            </span>
            <span v-else class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-yellow-100 text-yellow-800 border border-yellow-200 mt-2">
              ENVIRONMENT: SANDBOX
            </span>
          </div>
        </div>
